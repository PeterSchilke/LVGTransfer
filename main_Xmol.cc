...
//
//  Time-stamp: <2006-01-03 17:49:52 schilke> 
//
...
int main()
{
    ...
    cout << "\tsupported molecules:" << BOLD << " CO 13CO C18O SiO CS HCO+ " << OFF << endl;
    cout << "\t                    " << BOLD << " HCN HNC DCN HC3N OI      " << OFF << endl;
...
// now define the size - no check here, but later on
    ...
    try 
	{
	    ...
	    if (Type == "LinearVib") 
		{
		    ...
		    thisMol.printPars();
		    thisMol.DoCalc_Xmol(thisCloud, sl, &bo);
		}
