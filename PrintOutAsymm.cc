...
//
//  Time-stamp: <2008-11-17 17:37:07 schilke> 
//
#include <iostream>
#include <iomanip>
#include "Mols.h"
...
void AsymmetricRotor::PrintOut(Cloud &thisCloud)
{
    int i, f;
...
// header
    ...
    outFile << " Ji Kpi Kmii Jf Kpf Kmff    T_ex        freq    tau(Back)    T_l(Back)     tau(HII)     T_l(HII)     T_bg             tau          T_l" 
	    << endl;



    if (Convergence == 1)
	// write negative temperature if not converged
	{
...
//		cout << RJ(T_ex,freq) << " " <<  RJ(T_cosmic,freq) << " " << tau << " " << (1. - exp(-tau)) << endl;
		
		
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Ji;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Kpi;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Kmi;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Jf;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Kpf;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Kmf;
		cout.setf(ios::fixed, ios::floatfield);
		...
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << Kpi;
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << Kmi;
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << Jf;
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << Kpf;
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << Kmf;
		outFile.setf(ios::fixed, ios::floatfield);
