...
//
//  Time-stamp: <2006-01-03 16:56:39 schilke> 
//
#include <iostream>
#include <iomanip>
#include "Mols.h"
...
void AsymmetricRotorT::PrintOut(Cloud &thisCloud)
{
    int i, f;
...
// header
    ...
    cout << " Ji Ki vti Jf Kf vtf   T_ex        freq    tau(Back)    T_l(Back)     tau(HII)     T_l(HII)        T_bg          tau         T_l"  
	 << endl;
    ...
    outFile << " Ji Ki vti Jf Kf vtf    T_ex        freq    tau(Back)    T_l(Back)     tau(HII)     T_l(HII)     T_bg             tau          T_l" 
	    << endl;
...
//		cout << RJ(T_ex,freq) << " " <<  RJ(T_cosmic,freq) << " " << tau << " " << (1. - exp(-tau)) << endl;
		...
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << vti;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(4) << setprecision(0) << Jf;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Kf;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << vtf;
		cout.setf(ios::fixed, ios::floatfield);
		...
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << vti;
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(4) << setprecision(0) << Jf;
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << Kf;
		outFile.setf(ios::fixed, ios::floatfield);
		outFile << setw(3) << setprecision(0) << vtf;
		outFile.setf(ios::fixed, ios::floatfield);
