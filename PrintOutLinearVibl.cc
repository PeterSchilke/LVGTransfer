...
//
//  Time-stamp: <2006-01-03 16:43:36 schilke> 
//
#include <iostream>
#include <iomanip>
#include "Mols.h"
...
void LinearVibl::PrintOut(Cloud &thisCloud)
{
    int i, f;
...
// header
    ...
    cout << " Ji vi li  Jf vf lf    T_ex        freq    tau(Back)    T_l(Back)     tau(HII)     T_l(HII)        T_bg          tau         T_l"  
	 << endl;
    ...
    outFile << " Ji  vi   li  Jf  vf  lf   T_ex        freq    tau(Back)    T_l(Back)     tau(HII)     T_l(HII)     T_bg             tau          T_l" 
	    << endl;
...
//			      - RJ(thisCloud.Tdust(),freq)*(1-exp(-tau_d_inf))
		...
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << li;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << Jf;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << vf;
		cout.setf(ios::fixed, ios::floatfield);
		cout << setw(3) << setprecision(0) << lf;
		cout.setf(ios::fixed, ios::floatfield);
